...
# Enter project ID and Bucket ID here or set up the env
PROJECT_ID = os.environ.get("GCP_PROJECT_ID", "Enter Here")
BUCKET = os.environ.get("GCP_GCS_BUCKET", "Enter Here")
...
BIGQUERY_DATASET = os.environ.get("BIGQUERY_DATASET", 'weather_all')
...
with DAG(
 ...
 max_active_runs=1,
    ...
    download_dataset_task = BashOperator(
        ...
        bash_command=f'wget -r -l1 -nd -A "*.tar.gz" {dataset_url} -P {path_to_local_home}/noaa'
            )
